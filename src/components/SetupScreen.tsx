        ...
        <div className="space-y-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div className="space-y-4">
              <label className="flex items-center gap-2 text-sm font-black uppercase tracking-widest text-slate-500 dark:text-slate-500">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full glass-input-premium appearance-none cursor-pointer text-lg font-bold"
                >
                  {LANGUAGES.map(lang => (
            ...
            <div className="space-y-4">
              <label className="flex items-center justify-between text-sm font-black uppercase tracking-widest text-slate-500 dark:text-slate-500">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button
              ...
              className="neon-button flex-1 gap-3 py-5"
            >
              {isGenerating ? (
            ...
            <button
              ...
              disabled={isGenerating}
              className="flex items-center justify-center gap-2 px-8 py-5 rounded-2xl bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 font-bold hover:bg-slate-200 dark:hover:bg-slate-800 transition-all border border-slate-200 dark:border-slate-800"
            >
