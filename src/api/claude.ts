...
【レベルの目安】
0: 超入門レベル - 基本的な文法ミス、変数名の誤り、非常に明らかなバグ
1-3: 初級レベル - 基本的な構文エラー、明らかなバグ、コードスタイル違反
4-6: 中級レベル - パフォーマンスの問題、エッジケースの考慮不足、セキュリティの軽微な欠陥、一般的なアンチパターン
7-10: 上級レベル - 設計上の欠陥（SOLID原則違反など）、並行処理のバグ、複雑なセキュリティホール、スケーラビリティの問題
